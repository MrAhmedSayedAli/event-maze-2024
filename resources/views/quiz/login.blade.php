...
{{--        <p class="text-center font-bold">Don’t forget to be fast!</p>--}}
        ...
        <div>
            <x-input-label for="group_id" :value="__('To start, enter your code')" />
            <x-text-input id="group_id" class="block mt-1 w-full" type="text" name="group_id" :value="old('group_id')" required autofocus autocomplete="group_id" />
